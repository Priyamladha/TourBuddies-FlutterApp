...
class MapMarkerExample {
  ...
  MapMarkerExample(BuildContext context, HereMapController hereMapController) {
    ...
    _hereMapController.camera.lookAtPointWithDistance(
        GeoCoordinates(28.414881, 77.309692), distanceToEarthInMeters);
...
//    print(distance);
    ...
    while (distance > 500) {
      ...
      _hereMapController.camera
          .lookAtPointWithDistance(geoCoordinates, distance);
      distance -= 7000;
    }
...
//  }
  ...
  GeoCoordinates _setcurrentGeoCoordinatesInViewport(double lat, double long) {
